...
@Slf4j
public class WipeOutR_T_Model1 extends CDRModel implements IChocoModel, IDebuggingModel, ITestCaseRedundancyDetectable {
    ...
    public void identifyExpectedResults() {
        ...
        nonRedundantTestcases.add(IteratorUtils.get(testcases.iterator(), 2));
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        WipeOutR_T_Model1 clone = (WipeOutR_T_Model1) super.clone();
