...
echo ""
java -jar ../app/solver_runtime.jar -cfg ../conf/solver_runtime/solver_runtime_13972_red.cfg
echo "--------------------"
echo "|CF| = 13,972, solv. non-red."
echo ""
java -jar ../app/solver_runtime.jar -cfg ../conf/solver_runtime/solver_runtime_13972_nonred.cfg

echo "--------------------"
echo "|CF| = 18,342, solv. red."
echo ""
java -jar ../app/solver_runtime.jar -cfg ../conf/solver_runtime/solver_runtime_18342_red.cfg
echo "--------------------"
echo "|CF| = 18,342, solv. non-red."
echo ""
java -jar ../app/solver_runtime.jar -cfg ../conf/solver_runtime/solver_runtime_18342_nonred.cfg

echo "--------------------"
echo "|CF| = 30,572, solv. red."
echo ""
java -jar ../app/solver_runtime.jar -cfg ../conf/solver_runtime/solver_runtime_30572_red.cfg
echo "--------------------"
echo "|CF| = 30,572, solv. non-red."
echo ""
java -jar ../app/solver_runtime.jar -cfg ../conf/solver_runtime/solver_runtime_30572_nonred.cfg
...
echo "|T| = 10, red.% = 90"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_10_90.cfg
echo "--------------------"
echo "|T| = 10, red.% = 50"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_10_50.cfg
echo "--------------------"
echo "|T| = 10, red.% = 0"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_10_0.cfg

echo "--------------------"
echo "|T| = 50, red.% = 90"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_50_90.cfg
echo "--------------------"
echo "|T| = 50, red.% = 50"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_50_50.cfg
echo "--------------------"
echo "|T| = 50, red.% = 0"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_50_0.cfg

echo "--------------------"
echo "|T| = 100, red.% = 90"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_100_90.cfg
echo "--------------------"
echo "|T| = 100, red.% = 50"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_100_50.cfg
echo "--------------------"
echo "|T| = 100, red.% = 0"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_100_0.cfg

echo "--------------------"
echo "|T| = 250, red.% = 90"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_250_90.cfg
echo "--------------------"
echo "|T| = 250, red.% = 50"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_250_50.cfg
echo "--------------------"
echo "|T| = 250, red.% = 0"
echo ""
java -jar ../app/wipeoutr_t.jar -cfg ../conf/wipeoutr_t/wipeoutr_t_250_0.cfg
